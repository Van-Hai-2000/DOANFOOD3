             ...
             <ul class="nav navbar-nav navbar-right">
				  ...
				  <a href="#" class="dropdown-toggle avatar crunch-profile-log" data-toggle="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						<li class="m_2"><a href="<?php echo URL_KM_PROFILE;?>"><i class="fa fa-user"></i><?php echo get_languageword('Hồ sơ');?></a></li>
						
						<li class="m_2"><a href="<?php echo URL_KM_CHANGE_PASSWORD;?>"><i class="fa fa-lock"></i> <?php echo get_languageword('đổi mật khẩu');?> </a></li>
