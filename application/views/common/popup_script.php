       ...
       <div class="login-block">
       	...
       	<!-- <div class="row"> -->
  			...
  			<!-- <div class="col-sm-6"> -->
                ...
                <div class="login-block-header text-center"><img src="<?php echo FRONT_IMAGES;?>food.svg" alt="Login" class="d-icon"><?php echo get_languageword('Đăng nhập');?></div>
				...
				<?php 
                    ...
                    <div class="form-group">
                        <button type="submit" name="login" class="btn btn-primary btn-block "><b><?php echo get_languageword('Đăng nhập');?></b></button>
                    </div>
					
                    <div class="form-group">
					
                        <a href="#" onclick="show_popup('<?php echo $signup_modal;?>')" class="sing-link"><?php echo get_languageword('đăng ký');?></a>
                        <a href="#" onclick="show_popup('<?php echo $forgot_modal;?>')" class="forgot-password-link "><?php echo get_languageword('Quên mật khẩu?');?></a>
                    </div>
                ...
                <div class="login-with-social">
                   ...
                   <span><?php echo get_languageword('hoặc đăng nhập qua');?></span> 
  ...
  <div class="modal-dialog ">
    ...
    <div class="modal-content">
      <div class="modal-body">
       <div class="login-block">
                 <button type="button" class="close modal-close" data-dismiss="modal">&times;</button>
                <div class="login-block-header text-center"><img src="<?php echo FRONT_IMAGES;?>food.svg" alt="Register" class="d-icon"><?php echo get_languageword('Đăng ký');?></div>
                ...
                <?php 
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <button type="submit" name="register" class="btn btn-primary btn-block "><b><?php echo get_languageword('Đăng ký');?></b></button>
                    </div>
					
                    <div class="form-group">
					
                        <a href="#" onclick="show_popup('<?php echo $lgin_modal;?>')" class="sing-link"><?php echo get_languageword('Đăng nhập');?></a>
                        <a href="<?php echo URL_TERMS_CONDITIONS;?>" class="forgot-password-link"><?php echo get_languageword('Điều khoản và điều kiện');?></a>
                    </div>
                ...
                <div class="login-with-social">
                   <span><?php echo get_languageword('hoặc đăng ký thông qua');?></span> 
  ...
  <div class="modal-dialog ">
    ...
    <div class="modal-content">
      <div class="modal-body">
       <div class="login-block">
                 <button type="button" class="close modal-close" data-dismiss="modal">&times;</button>
                <div class="login-block-header text-center"><img src="<?php echo FRONT_IMAGES;?>food.svg" alt="Forgot Password" class="d-icon"><?php echo get_languageword('Quên mật khẩu?');?></div>
               ...
               <?php 
                    ...
                    <div class="form-group">
                        <button type="submit" name="forgot_pwd" class="btn btn-primary btn-block "><b><?php echo get_languageword('Gửi đi');?></b></button>
                    </div>
					
					
                    <div class="form-group">
					
					<a href="#" onclick="show_popup('<?php echo $lgin_modal;?>')" class="forgot-password-link"><?php echo get_languageword('Đăng nhập');?></a>
                ...
                <div class="login-with-social">
                   <span><?php echo get_languageword('hoặc đăng nhập qua');?></span> <a href="#"><img src="<?php echo FRONT_IMAGES;?>sign-g.svg" alt="" class="sc-icn"></a><a href="#"><img src="<?php echo FRONT_IMAGES;?>sign-f.svg" alt="" class="sc-icn"></a>
                </div>
            </div>
      </div>
    </div>
          ...
          setupFormValidation: function()
          {
			...
			//form validation rules
              $("#login_form").validate({
				 ...
				 messages: {
					 email: {
						 required: "<?php echo get_languageword('Email - bắt buộc');?>"
					 },
                     password: {
						required: "<?php echo get_languageword('mật khẩu được yêu câu');?>"
					 }
   			},
              ...
              $("#register_form").validate({
				 ...
				 messages: {
					 ...
					 first_name: {
						 ...
						 required: "<?php echo get_languageword('Tên ');?>"

					 },

                     last_name: {

						required: "<?php echo get_languageword('Họ tên');?>"

					 },

					 email: {

						 required: "<?php echo get_languageword('Email');?>"

					 },

					 phone: {

						 required: "<?php echo get_languageword('Số điện thoại');?>"

					 },

					 password: {

						 required: "<?php echo get_languageword('Mật khẩu');?>"
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="login-block">
               ...
               <div class="login-block-header text-center"><?php echo get_languageword('Thêm địa chỉ');?></div>
               ...
               <?php 
				 ...
				 echo form_open(URL_CART_ADD_ADDRESS,$attributes);?>
                    ...
                    <div class="form-group">
                        <button type="submit" name="address" class="btn btn-primary btn-block "><b><?php echo get_languageword('Thêm');?></b></button>
                    </div>
          ...
          setupFormValidation: function()
          {
			...
			//form validation rules
              $("#address_form").validate({
				 ...
				 messages: {
					 city_id: {
						 required: "<?php echo get_languageword('Thành phố');?>"
					 },
                     locality: {
						required: "<?php echo get_languageword('địa phương');?>"
					 },
					 pincode: {
						 required: "<?php echo get_languageword('yêu cầu mã pin');?>"
					 },
					 house_no: {
						 required: "<?php echo get_languageword('Nhà');?>"
					 },
					 street: {
						 required: "<?php echo get_languageword('Đường phố');?>"
					 },
					 landmark: {
						 required: "<?php echo get_languageword('dấu mốc');?>"
					 }
