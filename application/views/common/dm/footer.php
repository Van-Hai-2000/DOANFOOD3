  ...
  <?php echo form_open(URL_DM_VIEW_ORDER);?>
    ...
    <div class="modal-content order-content">
      ...
      <div class="modal-body">
		<p><?php echo get_languageword('quản trị viên đã được gửi một đơn đặt hàng');?></p>
	  ...
	  <div class="order-modal-footer modal-footer">
		...
		<button type="submit" class="btn btn-primary" name="view_order"><?php echo get_languageword('có');?></button>
...
<div id="km_dm_modal" class="modal fade" role="dialog">
  ...
  <?php echo form_open(URL_DM_VIEW_ORDER);?>
    ...
    <div class="modal-content order-content">
      ...
      <div class="modal-body">
		<p><?php echo get_languageword('quản lý nhà bếp đã được gửi một đơn đặt hàng');?></p>
		<p><?php echo get_languageword('bạn có muốn xem không');?>?</p>
