...
<head>
    ...
    <title> <?php if(isset($pagetitle)) echo $pagetitle;?> :: <?php echo get_languageword('bảng quản trị');?> :: </title>
             ...
             <ul class="nav navbar-nav navbar-right">
			  ...
			  <li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<span class="hidden-xs"><?php echo get_languageword('thay đổi ngôn ngữ');?></span>
					</a>
			  ...
			  <?php } ?>
				  ...
				  <a href="#" class="dropdown-toggle avatar crunch-profile-log" data-toggle="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						<li class="m_2"><a href="<?php echo URL_ADMIN_PROFILE;?>"><i class="fa fa-user"></i><?php echo get_languageword('Hồ sơ');?></a></li>
						<li class="m_2"><a href="<?php echo URL_ADMIN_CHANGE_PASSWORD;?>"><i class="fa fa-lock"></i> <?php echo get_languageword('đổi mật khẩu');?> </a></li>
						
						<li class="m_2"><a href="<?php echo URL_ADMIN_ORDERS_OVERVIEW;?>"><i class="fa fa-calendar"></i> <?php echo get_languageword('tổng quan về đơn hàng');?> </a></li>
						
						<li class="m_2"><a href="<?php echo URL_AUTH_LOGOUT;?>"><i class="fa fa-sign-out"></i> <?php echo get_languageword('đăng xuất');?> </a></li>	
	        		</ul>
	      		</li>
