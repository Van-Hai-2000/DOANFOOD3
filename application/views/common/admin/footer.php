  ...
  <?php echo form_open(URL_VIEW_ORDER);?>
    ...
    <div class="modal-content order-content">
      <div class="order-modal-header">
        ...
        <h4 class="modal-title"><?php echo get_languageword('đơn hàng mới');?></h4>
      </div>
      <div class="modal-body">
		<p class="text-dark"><?php echo get_languageword('bạn có đơn đặt hàng mới, bạn có muốn xem');?>?</p>
...
<?php echo form_open(URL_VIEW_ORDER);?>
    ...
    <div class="modal-content order-content">
      ...
      <div class="modal-body">
		<p><?php echo get_languageword('quản lý nhà bếp đã được gửi một đơn đặt hàng đến quản lý giao hàng');?></p>
		<p><?php echo get_languageword('bạn có muốn xem không');?>?</p>
...
<?php echo form_open(URL_VIEW_ORDER);?>
    ...
    <div class="modal-content order-content">
      ...
      <div class="modal-body">
		<p><?php echo get_languageword('người quản lý giao hàng đã được cập nhật trạng thái đơn hàng là đã giao');?></p>
		<p><?php echo get_languageword('bạn có muốn xem không');?>?</p>
