    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                ...
                <p class="footer-text"><?php echo get_languageword('chúng tôi là nhà cung cấp thực phẩm đẳng cấp thế giới với chất lượng dịch vụ thực phẩm cao nhất');?></p>
            ...
            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                <h4 class="footer-head"><?php echo get_languageword('Các khoản thanh toán được chấp nhận');?></h4>
        ...
        <?php } ?>
            <div class="col-lg-<?php echo $clg; ?> col-md-4 col-sm-6 col-xs-6">
                ...
                <ul class="cs-footer-links">
                    <li><a href="<?php echo SITEURL;?>"><?php echo get_languageword('Trang chủ');?></a>
                    </li>
					<li><a href="<?php echo URL_FAQS;?>"><?php echo get_languageword('câu hỏi thường gặp');?></a>
                    </li>
                    <li><a href="<?php echo URL_CONTACT_US;?>"><?php echo get_languageword('liên hệ chúng tôi');?></a>
                    </li>
                    <li><a href="<?php echo URL_SITE_MAP;?>"><?php echo get_languageword('sơ đồ trang web');?></a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-<?php echo $clg; ?> col-md-4 col-sm-6 col-xs-6">
                ...
                <h4 class="footer-head"><?php echo get_languageword('liên kết của chúng tôi');?></h4>
                <ul class="cs-footer-links">
					<?php if (in_array('about-us', $cms_pages)) { ?>
                    <li><a href="<?php echo URL_ABOUT_US;?>"><?php echo get_languageword('về chúng tôi');?></a>
                    </li>
                    <?php } if (in_array('how-it-works', $cms_pages)) { ?>

                    <li><a href="<?php echo URL_HOW_IT_WORKS;?>"><?php echo get_languageword('làm thế nào nó hoạt động');?></a>
                    </li>
                    <?php }  if (in_array('terms-conditions', $cms_pages)) { ?>

                    <li><a href="<?php echo URL_TERMS_CONDITIONS;?>"><?php echo get_languageword('Điều khoản và điều kiện');?></a>
                    </li>
                    <?php } if (in_array('privacy-policy', $cms_pages)) { ?>

                    <li><a href="<?php echo URL_PRIVACY_POLICY;?>"><?php echo get_languageword('Chính sách bảo mật');?></a>
                    </li>
                      <?php } ?>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                <div class="media cs-media">
                    ...
                    <div class="media-body ct-media-bodys">
                        <h4 class="media-heading"><?php echo get_languageword('Thời gian mở cửa');?></h4>
                ...
                <div class="media cs-media">
                    ...
                    <div class="media-body ct-media-bodys">
                        <h4 class="media-heading"><?php echo get_languageword('gọi cho chúng tôi');?></h4>
                ...
                <div class="media cs-media">
                    ...
                    <div class="media-body ct-media-bodys">
                        <h4><?php echo get_languageword('Đối với Android'); ?></h4>
                        <p><?php echo get_languageword('Truy cập Cửa hàng Playstore'); ?></p>
                    </div>
                </div>
                <div class="media cs-media">
                    <div class="media-left ct-icon-font">
                    ...
                    <div class="media-body ct-media-bodys">
                        <h4><?php echo get_languageword('Đối với IOS'); ?></h4>
                        <p><?php echo get_languageword('Truy cập Apple Store'); ?></p>
                    </div>
                </div>
            ...
            <div class="row">
				...
				<div class="col-sm-6 hidden-xs">
                    <ul class="copyright-links">
                        ...
                        <li class="dropdown ct-lang">
                            <a href="#" onclick="show_popup('login')" class="dropdown-toggle ct-toggle ct-padding"> <?php echo get_languageword('Đăng nhập');?> </a>
                        </li>
                        <li class="dropdown ct-lang">
                            <a href="#" onclick="show_popup('signup')" class="dropdown-toggle ct-toggle ct-padding"> <?php echo get_languageword('Đăng ký');?> </a>
                        </li>
                        <?php } ?>
                    </ul>
                </div>
