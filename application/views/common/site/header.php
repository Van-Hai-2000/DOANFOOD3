                         ...
                         <div class="ct-navbar">
                           <div class="navbar-offcanvas navbar-offcanvas-touch navbar-right" id="ct-bootstrap-offcanvas">
                              <ul class="nav navbar-nav ct-list">
                                  ...
                                  <li><a href="<?php echo URL_MENU;?>"><?php echo get_languageword('thực đơn');?></a></li>
								  
                                  <li><a href="<?php echo URL_ABOUT_US;?>"><?php echo get_languageword('về chúng tôi');?></a></li>
                                  <li><a href="<?php echo URL_CONTACT_US;?>"><?php echo get_languageword('liên hệ chúng tôi');?></a></li>
                                 
								<?php if (!$this->ion_auth->logged_in()):
								$login_popup='login';
								?>
								<li><a class="btn btn nav-btn" href="javascript:void(0);" onclick="show_popup('<?php echo $login_popup;?>')"><?php echo get_languageword('Đăng nhập');?></a></li>
								  
								  <?php else: ?>								
                               <li class="dropdown">
                  
                                    <a href="#" class="dropdown-toggle" type="button" data-toggle="dropdown"><img src="<?php echo get_user_image();?>" class="nav-profile-img" alt="Your Account"><?php echo get_languageword('tài khoản của tôi');?>
                  
                                    <span class="fa fa-angle-down"></span></a>
                  
                                    <ul class="dropdown-menu">
                  
                                      <li><a href="<?php echo URL_USER_PROFILE;?>"><i class="pe pe-7s-user"></i> <?php echo get_languageword('thông tin của tôi');?></a></li>
                    
                                      <li><a href="<?php echo URL_USER_MY_ORDERS;?>"><i class="pe pe-7s-box1"></i><?php echo get_languageword('đơn đặt hàng của tôi');?></a></li>
                    
										<li><a href="<?php echo URL_USER_MY_POINTS;?>"><i class="pe pe-7s-wallet"></i><?php echo get_languageword('điểm của tôi');?></a></li>
                    
                  
									<li role="separator" class="divider"></li>
                                      <li><a href="<?php echo URL_AUTH_LOGOUT;?>"><i class="pe pe-7s-next-2"></i><?php echo get_languageword('Đăng xuất');?></a></li>
