			...
			<table id="example" class="display responsive nowrap customers-table" width="100%" cellspacing="0">
			  	<thead>
					<tr>
						...
						<th class="text-left"><?php echo get_languageword('Tên khách hàng');?></th>
						<th class="text-left"><?php echo get_languageword('email');?></th>
						<th class="text-left"><?php echo get_languageword('số điện thoại');?></th>
						<th><?php echo get_languageword('Mã giới thiệu');?></th>
				...
				<tfoot>
					<tr>
						...
						<th><?php echo get_languageword('Số điện thoại');?></th>
						<th><?php echo get_languageword('Mã giới thiệu');?></th>
						<th><?php echo get_languageword('Trạng thái');?></th>
						<th><?php echo get_languageword('Hành động');?></th>
					</tr>
