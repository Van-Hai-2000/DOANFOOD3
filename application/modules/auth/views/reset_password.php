...
?>		 
		<h4 class="w-head"><?php echo get_languageword('Liên lạc');?></h4>
		<div class="c-media">
	...
	<h4 class="w-head mt-5"><?php echo get_languageword('Theo dõi chúng tôi');?></h4>
		...
		<!--address details for contactus-->
			...
			<button type="submit" name="reset_pwd" class="btn btn-primary"><?php echo get_languageword('Gửi');?> </button>
