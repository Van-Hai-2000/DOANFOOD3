  <!-- Slide Banner Section -->
   ...
   <!-- Slide Banner Section -->
          ...
          <div class="row">
            <div class="col-sm-12">
             <div class="section-header">
                 <h1><?php echo get_languageword('Đồ ăn đặc biệt');?></h1>
                 <p><?php echo get_languageword('Chúng ta có vinh quang khi bắt đầu kinh doanh nhà hàng');?></p>
             </div>
             </div>
           </div>
          </div>
       ...
       <?php } else { 
		...
		echo '<h4 style="text-align:center;">'.get_languageword('Không có mặt hàng nào').' </h4>';
