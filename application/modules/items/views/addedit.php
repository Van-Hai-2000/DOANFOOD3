				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							...
							<a title="<?php echo get_languageword('Danh sách'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_ITEMS_INDEX; ?>"><i class="fa fa-list"></i>
							</a>
                        </div>
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('Loại mặt hàng').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('Mó có phải là mặt hàng phổ biến không?').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					...
					<div class="col-md-6">
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('Miêu tả').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					...
					<div class="form-group pull-right">
						...
						<button type="submit" name="addedit_item" value="addedit_item" class="btn btn-primary"><?php echo get_languageword('Lưu');?></button>
