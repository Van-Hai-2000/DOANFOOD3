  <div id="page-wrapper">
               ...
               <div class="row">
				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							...
							<a title="<?php echo get_languageword('Đi đến danh sách'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_ITEMS_INDEX; ?>"><i class="fa fa-list"></i>
							</a>
                        </div>
				...
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><?php echo get_languageword('Mục chi tiết');?></a></li>

					<li role="presentation"><a href="#options" aria-controls="options" role="tab" data-toggle="tab"><?php echo get_languageword('Tùy chọn');?></a></li>
				</ul>	
				<!-- Nav tabs -->			
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="home">				 
					   ...
					   <div class="form-group">
						 <label><?php echo get_languageword('Thực đơn').required_symbol();?></label>
						<?php
						$val='';
					...
					<div class="form-group">
						<label><?php echo get_languageword('Tên mục').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					...
					<div class="form-group">
						 <label><?php echo get_languageword('Giá').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('Loại').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					  ...
					  <div class="form-group">
						<label><?php echo get_languageword('Thêm');?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('có phải nục phổ biến k?').required_symbol();?></label>
						<?php
					...
					<div class="col-md-6">
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('Sự miêu tả').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					   ...
					   <div class="form-group">
							<label><?php echo get_languageword('Ảnh').required_symbol();?>(<small><strong><?php echo ALLOWED_TYPES;?></strong></small>) <br> <small>For better resolution min & max  width*height : 263*180 & 526*360 </small> </label>
					...
					<div class="form-group">
						 <label><?php echo get_languageword('Trạng thái').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					...
					<div class="form-group pull-right">
						...
						<button type="submit" name="edit_item_save" value="edit_item_save" class="btn btn-primary"><?php echo get_languageword('Lưu');?></button>
						
						<a class="btn btn-warning" href="<?php echo URL_ITEMS_INDEX;?>"><?php echo get_languageword('Hủy');?></a>
					</div>
                  ...
                  <div class="col-md-12">
				    ...
				    <div class="col-md-4">
                      <div class="form-group">
                        <label><?php echo get_languageword('Tùy chọn');?><span style="color:red;">*</span></label>
                    ...
                    <div class="col-md-4">
                      ...
                      <label><?php echo get_languageword('Giá');?><span style="color:red;">*</span></label>
				   ...
				   <input type="hidden" name="option_count" id="option_count" value="<?php if(isset($item_selected_options) && count($item_selected_options)>0) echo count($item_selected_options)+1; else echo "1";?>">
                    ...
                    <table class="table table-bordered" id="first" border="1">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th><?php echo get_languageword('Tùy chọn');?></th>
                          <th><?php echo get_languageword('Giá bán');?></th>
                        </tr>
                      </thead>
                    ...
                    <div class="form-group pull-right">
					<button type="submit" name="item_options_save" class="btn btn-primary"><?php echo get_languageword('Thêm');?></button>
                    </div>
