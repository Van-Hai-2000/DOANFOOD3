				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							...
							<a title="<?php echo get_languageword('Đi đến danh sách'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_FAQS_CATEGORIES_INDEX; ?>"><i class="fa fa-list"></i>
                       ...
                       <div class="col-md-6">
						...
						<div class="form-group">
						 ...
						 <label><?php echo get_languageword('Thể loại').required_symbol();?></label>
					...
					<div class="form-group pull-right">
						...
						<button type="submit" name="addedit_fc" value="addedit_fc" class="btn btn-primary"><?php echo get_languageword('Lưu');?></button>

						

						<a class="btn btn-warning" href="<?php echo URL_FAQS_CATEGORIES_INDEX;?>"><?php echo get_languageword('Hủy');?></a>
                ...
                category: {
                    ...
                    validators: {
                        ...
                        notEmpty: {
                            ...
                            message: '<?php echo get_languageword('Danh mục câu hỏi thường gặp bắt buộc');?>'
