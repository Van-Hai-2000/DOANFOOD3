...
<section class="fc-identity fc-bottom fc-menu-wrapper">
		<div class="container">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 text-center">
				<div class="cs-sucess-msg"> <span class="pe pe-7s-like2"></span> <span><?php echo get_languageword('Đặt hàng thành công');?></span></div>
				...
				<p class="fc-success-text"><?php echo get_languageword('Đơn đặt hàng của bạn đã được nhận, chúng tôi sẽ liên hệ với bạn sớm');?></p>
				...
				<a href="<?php echo URL_USER_MY_ORDERS;?>" class="btn btn-warning"><?php echo get_languageword('Xem tất cả');?></a>
