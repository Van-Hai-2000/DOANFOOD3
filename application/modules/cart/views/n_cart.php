	...
	<?php echo form_open('',array('name'=>'cart-form','id'=>'cart-form'));?>
		...
		<div class="col-sm-9">
			...
			<div class="cs-card cart-card card-show">
      			<div class="card-header bordered clearfix"><span class="stat-count">2</span><?php echo get_languageword('Chi tiết giao hàng');?> <button type="button" data-toggle="modal" data-target="#address-modal" class="btn btn-outline-primary pull-right"><i class="pe-7s-plus"></i> <?php echo get_languageword('add_new_address');?></button></div>
      			<div class="cs-card-content card-items-list address-y-flow clearfix">
      				
      				<!-- Radio Checkbox -->
      				<div class="address-box-header"><?php echo get_languageword('Chọn địa chỉ giao hàng');?></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="pb-delivery-address" onclick="check_address('<?php echo $address->ua_id;?>');">
							...
							<label for="address<?php echo $k;?>" class="pb-radio-custom-label pb-radio-address-label"> <?php echo get_languageword('Giử đến địa chỉ này');?> </label>
			...
			if(!empty($redeem_points)) {
				$redm_sentnc .= get_languageword('Bạn có muốn đổi điểm đã kiếm được không?');
				
				$redm_sentnc .= '<br>';
				$redm_sentnc .= get_languageword('you_have_').$redeem_points[1].' '.get_languageword('Điểm');
			...
			<div class="cs-card cart-card mt-2 payment-card-hide">
      			<div class="card-header bordered"><span class="stat-count">3</span><?php echo get_languageword('Đổi điểm');?></div>
      			<div class="cs-card-content card-items-list">
					...
					<div class="col-lg-6 col-md-7 col-sm-12">
                        <div class="pb-delivery-address pb-radeem-points">
                            ...
                            <div class="points-radeem"> <i class="pe pe-7s-wallet"></i> <b><?php echo $redeem_points[2];?> <?php echo get_languageword('Điểm');?> </b> </div>
                            ...
                            <label for="user_points" class="pb-radio-custom-label pb-radio-address-label"> <?php echo get_languageword('Đổi');?> </label>
			...
			<!--POINTS-->
      		...
      		<!--Payment-->
      		<div class="cs-card cart-card mt-2 payment-card-hide">
      			<div class="card-header bordered"><span class="stat-count"><?php echo $pay_no;?></span><?php echo get_languageword('Thanh toán');?></div>
      			<div class="cs-card-content card-items-list">
      				<div class="row">
				  ...
				  <div class="col-md-5 col-sm-12" onclick="show_cards()">
				   ...
				   <div class="col-md-5 col-sm-12" onclick="show_cards()">
                        <div class="pb-radio-netbanking">
                            ...
                            <label for="cash" class="pb-radiobox-popular-label pb-radio-address-label"> &nbsp; <?php echo get_languageword('Thanh toán khi giao hàng');?> </label>
                        </div>
                    </div>
				   ...
				   <div class="row">
				    <div class="col-md-5 col-sm-12">
                        <div class="pb-radio-netbanking" onclick="show_cards()">
                            ...
                            <label for="cashCard" class="pb-radiobox-popular-label pb-radio-address-label"> &nbsp; <?php echo get_languageword('Thẻ khi giao hàng');?> </label>
                        </div>
		...
		<div class="col-sm-3" id="item-sidebar">
      	...
      	<div class="card-header bordered"><?php echo get_languageword('Giỏ hàng của bạn');?></div>
			
			
		<div id="cart-div">
		
		</div>
		<button type="submit" name="submit_type" value="save_order" class="btn btn-primary btn-block btn-checkout" id="book_order" > <?php echo get_languageword('Tiếp tục');?> </button>
		</div>
...
$('#book_order').click(function() {
	...
	{
		checkNotify('CART','<?php echo get_languageword('vui lòng cung cấp địa chỉ giao hàng')?>','error');
		return false;
	}
	...
	{
		checkNotify('CART','<?php echo get_languageword('vui lòng chọn phương thức thanh toán')?>','error');
		return false;
	}
});
