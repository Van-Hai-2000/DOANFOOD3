				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							...
							<a title="<?php echo get_languageword('Danh sách'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_ITEM_TYPES_INDEX; ?>"><i class="fa fa-list"></i>
					...
					<div class="form-group pull-right">
						...
						<button type="submit" name="addedit_item_type" value="addedit_item_type" class="btn btn-primary"><?php echo get_languageword('Lưu');?></button>

						

						<a class="btn btn-warning" href="<?php echo URL_ITEM_TYPES_INDEX;?>"><?php echo get_languageword('Hủy');?></a>
                ...
                item_type: {
                    ...
                    validators: {
                        ...
                        notEmpty: {
                            ...
                            message: '<?php echo get_languageword('Yêu cầu nhập loại');?>'
