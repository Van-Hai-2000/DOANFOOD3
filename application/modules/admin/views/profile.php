               ...
               <div class="row">
				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
						...
						echo form_open_multipart(URL_ADMIN_PROFILE,$attributes);?>
							
                       <div class="col-md-6">
                                 
						<div class="form-group">
						 <label><?php echo get_languageword('Họ').required_symbol();?></label>
						<?php
						$val='';
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('Tên').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					  ...
					  <div class="form-group">
						 <label><?php echo get_languageword('số điện thoại').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					 ...
					 <div class="form-group">
							<label><?php echo get_languageword('Ảnh').required_symbol();?>(<small><strong><?php echo ALLOWED_TYPES;?></strong></small>)</label>
					...
					<div class="form-group pull-right">
						<button type="submit" name="update_profile" value="update_profile" class="btn btn-primary"><?php echo get_languageword('Câp nhật');?></button>
						
						<a class="btn btn-warning" href="<?php echo URL_ADMIN_PROFILE;?>"><?php echo get_languageword('Hủy');?></a>
					</div>
        ...
        $('#profile_form').bootstrapValidator({
            ...
            fields: {
                first_name: {
                    validators: {
                        notEmpty: {
                            message: '<?php echo get_languageword('Yêu cầu nhập họ');?>'
                        }
                    }
                },
                last_name: {
                    validators: {
                        notEmpty: {
                            message: '<?php echo get_languageword('Yêu cầu nhập tên');?>'
                        }
                    }
                },
				phone: {
                    validators: {
                        notEmpty: {
                            message: '<?php echo get_languageword('Yêu cầu nhập số điện thoại');?>'
                        }
                    }
                },
				profile_image: {
                    validators: {
                       file: {
							...
							message: '<?php echo get_languageword('k nhận diện được file ảnh');?>'
						}
                    }
                }
