...
<div id="page-wrapper" class="bg-silver" >
			...
			<?php } ?>
			   ...
			   <?php echo $this->session->flashdata('message');?>
					...
					<a href="<?php echo URL_MENU_INDEX;?>" title="<?php echo get_languageword('Thực đơn');?>">
                        <div class="media stats-media-white bg-white">
                            ...
                            <div class="media-body text-right">
                                <p><?php echo get_languageword('Thực đơn');?></p>
                    ...
                    <div class="col-md-4 col-lg-3">
					<a href="<?php echo URL_ITEMS_INDEX;?>" title="<?php echo get_languageword('Mặt hàng');?>">
                        <div class="media stats-media-white bg-white">
                            <div class="media-left">
                                <img src="<?php echo FRONT_IMAGES;?>dashboard-fast-food.svg" width="50" height="50" alt="Items">
                            </div>
                            <div class="media-body text-right">
                                <p> <?php echo get_languageword('Mặt hàng');?></p>
                    ...
                    <div class="col-md-4 col-lg-3">
					<a href="<?php echo URL_ADDONS_INDEX;?>" title="<?php echo get_languageword('Thêm vào');?>">
                        <div class="media stats-media-white bg-white">
                            <div class="media-left">
                                <img src="<?php echo FRONT_IMAGES;?>dashboard-condiment.svg" width="40" height="40" alt="Addons">
                            </div>
                            <div class="media-body text-right">
                                <p><?php echo get_languageword('Thêm vào');?></p>
                    ...
                    <div class="col-md-4 col-lg-3">
					<a href="<?php echo URL_OPTIONS_INDEX;?>" title="<?php echo get_languageword('Tùy chọn');?>">
                        <div class="media stats-media-white bg-white">
                            <div class="media-left">
                                <img src="<?php echo FRONT_IMAGES;?>dashboard-pizza.svg" width="50" height="50" alt="Options">
                            </div>
                            <div class="media-body text-right">
                                <p><?php echo get_languageword('Tùy chọn');?></p>
					...
					<div class="col-md-4 col-lg-3">
					<a href="<?php echo URL_OFFERS_INDEX;?>" title="<?php echo get_languageword('Đề nghị');?>">
                        <div class="media stats-media-white bg-white">
                            <div class="media-left">
                                <img src="<?php echo FRONT_IMAGES;?>dashbaoard-voucher.svg" width="50" height="50" alt="Offers">
                            </div>
                            <div class="media-body text-right">
                                <p><?php echo get_languageword('Đề nghị ');?></p>
                ...
                <div class="col-md-4 col-lg-3">
				 <a href="<?php echo URL_CUSTOMERS_INDEX;?>" title="<?php echo get_languageword('Khách hàng');?>">
					<div class="media stats-media-white bg-white">
						<div class="media-left">
							<img src="<?php echo FRONT_IMAGES;?>dashboard-network.svg" width="50" height="50" alt="Customers">
						</div>
						<div class="media-body text-right">
							<p><?php echo get_languageword('Khách hàng');?></p>
                ...
                <div class="col-md-4 col-lg-3">
				 <a href="<?php echo URL_ORDERS_INDEX;?>" title="<?php echo get_languageword('Đơn hàng mới');?>">
					<div class="media stats-media-white bg-white">
						<div class="media-left">
							<img src="<?php echo FRONT_IMAGES;?>dashboard-list.svg" width="50" height="50" alt="Orders">
						</div>
						<div class="media-body text-right">
							<p><?php echo get_languageword('Đơn hàng mới');?></p>
