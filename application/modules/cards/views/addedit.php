               ...
               <div class="row">
				...
				<?php echo $this->session->flashdata('message'); ?>
					...
					<div class="form-group">
							<label><?php echo get_languageword('Hình ảnh').required_symbol();?>(<small><strong><?php echo ALLOWED_TYPES;?></strong></small>)</label>
					...
					<div class="form-group">
						 <label><?php echo get_languageword('Văn bản thay thế');?></label>
						<?php
						$val='';
					...
					<div class="form-group">
						 <label><?php echo get_languageword('Tình trạng').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					...
					<div class="form-group pull-right">
						...
						<button type="submit" name="addedit_card" value="addedit_card" class="btn btn-primary"><?php echo get_languageword('Lưu');?></button>
						
						<a class="btn btn-warning" href="<?php echo URL_CARDS_INDEX;?>"><?php echo get_languageword('Hủy');?></a>
					</div>
				...
				card_image: {
                    validators: {
                       file: {
							...
							message: '<?php echo get_languageword('Ảnh thẻ k phù hợp');?>'
						}
                    }
                }
