				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
					  ...
					  <div class="form-group">
						 ...
						 <label><?php echo get_languageword('SDT').required_symbol();?></label>
					...
					<div class="form-group pull-right">
						...
						<button type="submit" name="update_profile" value="update_profile" class="btn btn-primary"><?php echo get_languageword('Cập nhật');?></button>

						

						<a class="btn btn-warning" href="<?php echo URL_DM_PROFILE;?>"><?php echo get_languageword('Hủy');?></a>
                ...
                first_name: {
                    ...
                    validators: {
                        ...
                        notEmpty: {
                            ...
                            message: '<?php echo get_languageword('Nhap họ');?>'
                ...
                last_name: {
                    ...
                    validators: {
                        ...
                        notEmpty: {
                            ...
                            message: '<?php echo get_languageword('nhập tên');?>'
				...
				phone: {
                    ...
                    validators: {
                        ...
                        notEmpty: {
                            ...
                            message: '<?php echo get_languageword('nhập sdt vào');?>'
