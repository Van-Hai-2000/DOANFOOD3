               ...
               <div class="row">
				...
				<?php echo $this->session->flashdata('message'); ?>
					...
					<div class="form-group pull-right">
						...
						<a class="btn btn-warning" href="<?php echo URL_DM_CHANGE_PASSWORD;?>"><?php echo get_languageword('Hủy');?></a>
              ...
              $("#password_form").validate({
				 ...
				 messages: {
					 ...
					 old_password: {
						 ...
						 required: "<?php echo get_languageword('Yêu cầu nhập mật khẩu cũ');?>"

					 },

					 new_password: {

						 required: "<?php echo get_languageword('nhập mật khẩu mới');?>"

					 },

					 new_confirm_password: {

						 equalTo: "<?php echo get_languageword('nhập lại mật khẩu');?>"
