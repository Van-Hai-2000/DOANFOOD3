				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							...
							<a title="<?php echo get_languageword('Đi đến danh sách'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_ADDONS_INDEX;?>"><i class="fa fa-list"></i>
							</a>
                        </div>
                       ...
                       <div class="col-md-6">
						...
						<div class="form-group">
						 <label><?php echo get_languageword('Thêm tên').required_symbol();?></label>
						<?php
						$val='';
					...
					<div class="form-group">
						 <label><?php echo get_languageword('Giá bán').required_symbol();?></label>
						<?php
						$val='';
						if(isset($record) && !empty($record))
						{
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
							<label><?php echo get_languageword('Thêm ảnh').required_symbol();?>(<small><strong><?php echo ALLOWED_TYPES;?></strong></small>)</label>
					...
					<div class="form-group pull-right">
						...
						<button type="submit" name="addedit_addon" value="addedit_addon" class="btn btn-primary"><?php echo get_languageword('Thêm');?></button>
						
						<a class="btn btn-warning" href="<?php echo URL_ADDONS_INDEX;?>"><?php echo get_languageword('Hủy');?></a>
					</div>
        ...
        $('#addon_from').bootstrapValidator({
            ...
            fields: {
                addon_name: {
                    validators: {
                        notEmpty: {
                            message: '<?php echo get_languageword('Bắt buộc');?>'
                        }
                    }
                },
                price: {
				...
				addon_image: {
                    validators: {
                       file: {
							...
							message: '<?php echo get_languageword('Thêm ảnh k hợp lệ');?>'
						}
                    }
                }
